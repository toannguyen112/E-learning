    ...
    return (
      <div className="banner">
        <div className="banner__content container">
          <div className="row">
            <div
              className=" banner__caterory col-md-3 col-sm-3"
              style={{ width: "100%" }}
            >
              <div className="banner__menu">
                <div className="banner__menu__content">
                  ...
                  <ul>
                    ...
                    <li>
                      {" "}
                      <Link style={{ color: "red" }} to="/courses">
                        View more ...
                      </Link>
                    </li>
                  </ul>
            ...
            <div
              className=" banner__pr col-lg-6 col-md-12 "
              style={{ height: "100%" }}
            >
            ...
            <div
              className=" banner__pr-2 col-lg-3 col-md-6"
              style={{ height: "100%" }}
            >
              <div className="banner__tab">
                <ul>
                  <li>
                    <img
                      src="https://dvch1hlupt.cdn.hostvn.net/button/image/255x160_32.png"
                      alt=""
                    />
                  </li>
                  <li>
                    <img
                      src="https://dvch1hlupt.cdn.hostvn.net/button/image/255x160_33.png"
                      alt=""
                    />
                  </li>
                  <li>
                    <img
                      src="https://dvch1hlupt.cdn.hostvn.net/button/image/255x160_34.png"
                      alt=""
                    />
                  </li>
                </ul>
