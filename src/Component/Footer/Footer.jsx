            ...
            <footer className="footer">
                <div className="footer_content container">
                    ...
                    <div className="footer_bot row" >
                        ...
                        <div className=" footer__bot--left col-md-6 col-sm-12 d-flex">
                            <div className="footer_img">
                                <img className="img-fluid" src="https://www.udemy.com/staticx/udemy/images/v6/logo-coral.svg" alt="" /></div>
                        ...
                        <div className=" footer__bot--right col-md-6  col-sm-12">
                            <div className="footer_bot_info d-flex">
                                <a className="mr-3" href="https://www.facebook.com/">Terms</a>
